...
#define EN_RIGHT_Pin GPIO_PIN_1
...
#define DIR_RIGHT_Pin GPIO_PIN_4
#define DIR_RIGHT_GPIO_Port GPIOA
#define DIR_LEFT_Pin GPIO_PIN_5
#define DIR_LEFT_GPIO_Port GPIOA
#define EN_LEFT_Pin GPIO_PIN_6
...
#define TX_INV_Pin GPIO_PIN_8
#define TX_INV_GPIO_Port GPIOA
#define USART1_RX_Pin GPIO_PIN_10
#define USART1_RX_GPIO_Port GPIOA
#define RX_INV_Pin GPIO_PIN_11
#define RX_INV_GPIO_Port GPIOA
